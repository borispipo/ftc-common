...
export const AUTH_SIGN_IN = AUTH_LOGIN_USER;

export const AUTH_LOGOUT_USER= "AUTH_LOGOUT_USER";
export const AUTH_SIGN_OUT = AUTH_LOGIN_USER;
...
export const UPSERT_POUCHDB_DATA_FILE = "UPSERT_POUCHDB_DATA_FILE";

export const REMOVE_POUCHDB_DATA_FILE = "REMOVE_POUCHDB_DATA_FILE";
...
export default {
    ...
    UPSERT_POUCHDB_DATA_FILE,
    REMOVE_POUCHDB_DATA_FILE,
    AUTH_UPDATE_PROFILE,
    ...appEvents,
}